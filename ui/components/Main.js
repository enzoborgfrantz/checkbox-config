    ...
    selectDomain(e) {
        ...
        this.setState({
            selectedDomains: selectedDomains.length > 0
                ...
                : '',
            adConfigVisible: selectedDomains.length > 0,
    ...
    render() {
        return (
            <div className="mainContainer">
                <DomainPicker onClick={(e) => {
                    this.selectDomain(e)
                }}/> {this.state.adConfigVisible
                    ? <AdConfigurationContainer configurations={this.state.configurations} selectedDomains={this.state.selectedDomains}/>
                    : null}
